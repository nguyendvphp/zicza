...
class WUsersController extends WebController
{
	/**
		...
		if(isset($_POST['wUsers']))
		{
			...
			if($model->save())
                ...
                $this->render('alert',array(
        			'msg'=>Yii::t('web/app','register_success'),
        		));
	...
	{
		$dataProvider=new CActiveDataProvider('wUsers');
	...
	{
		$model=new wUsers('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['wUsers']))
			$model->attributes=$_GET['wUsers'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='w-users-form')
		{
