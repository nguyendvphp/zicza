...
class ACategoryGalleryController extends AController
{
	/**
	...
	public function accessRules()
	{
		return array(
            ...
            array('allow',
                'actions' => array('update','active','activeAll','unActiveAll','deleteAll'),
                'expression' => 'AUserPermission::checkUserPermission(Yii::app()->controller->id,"edit")',
            ),
            array('allow',
                'actions' => array('create','active','upload','imageupload'),
	...
	{
		$model=new ACategoryGallery;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);
        $file_id = isset($_POST['file_id']) ? $_POST['file_id'] : '';
		if(isset($_POST['ACategoryGallery']))
		{
			$model->attributes=$_POST['ACategoryGallery'];
            $model->thumbnail = $file_id;
    ...
    public function actionUpload(){
        if(isset($_FILES['files']) && $_FILES['files'])
    	{
	        ...
	        $img_arr = array();
			$file_info = AFunction::generate_file_name('categorygallery');
    ...
    public function actionActive(){
        ...
        $status = Yii::app()->getRequest()->getParam('status'); //var_dump($status); exit();
            ...
            $sql = "Update {{category_gallery}} SET status = '$status_new' WHERE id =".$id;
	...
	{
		$dataProvider=new CActiveDataProvider('ACategoryGallery');
	...
	{
		$model=new ACategoryGallery('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ACategoryGallery']))
			$model->attributes=$_GET['ACategoryGallery'];
	...
	{
		$model=ACategoryGallery::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='acategory-gallery-form')
		{
